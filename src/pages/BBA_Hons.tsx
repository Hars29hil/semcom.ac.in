...
const programOutcomes = [
  ...
  },
  {
    ...
    description: 'Reasoning informed by contextual knowledge to assess societal, health, safety, legal, and cultural issues and the consequent responsibilities.'
  }
];
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <div className="flex items-center gap-3 bg-surface px-5 py-3 rounded-xl border border-border">
                ...
                <span className="font-bold text-xs text-primary">120 Students Intake</span>
              </div>
              <div className="flex items-center gap-3 bg-surface px-5 py-3 rounded-xl border border-border">
                <ShieldCheck className="text-secondary" size={18} />
                <span className="font-bold text-xs text-primary">Industry Validated</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 card !p-6 max-w-[200px] border border-border shadow-soft hidden sm:block">
              ...
              <h4 className="font-bold text-xs text-primary mb-1">Top Ranked</h4>
              <p className="text-[9px] font-semibold text-muted leading-relaxed">Recognized globally for academic rigor and excellence.</p>
            </div>
          </motion.div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-stretch">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="card !p-6 flex flex-col items-center justify-center text-center border border-border shadow-sm bg-surface">
              ...
              <h4 className="text-sm font-bold text-primary mb-5">BBA (Hons.) Curriculum</h4>
